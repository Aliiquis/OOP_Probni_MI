...
public class Main {
    public static void main(String[] args) {
        hr.fer.oop.zad1.FlagCarriers croatiaAirlines = new hr.fer.oop.zad1.FlagCarriers("Croatia Airlines", new String[]{"Airbus A 320 - 200", "Airbus A 319 - 100", "Dash 8-Q400"}, 60);
        ...
        hr.fer.oop.zad1.Regional airCanadaExpress = new hr.fer.oop.zad1.Regional("Air Canada Express", new String[]{"Bombardier CRJ200ER", "Embraer 175"}, 15, 2);
